<h2><a href="https://leetcode.com/problems/super-washing-machines">517. Super Washing Machines</a></h2><h3>Hard</h3><hr><p>You have <code>n</code> super washing machines on a line. Initially, each washing machine has some dresses or is empty.</p>
